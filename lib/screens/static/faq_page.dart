...
class FaqPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StaticPageShell(
      ...
      lede: 'Did not find your question? Email founders@psyclinicai.com '
      ...
      child: const Column(
        ...
        children: [
          _Faq(
            ...
            a: 'No. Audio is transcribed on the clinician device by the '
          ...
          _Faq(
            q: 'How is PsyClinicAI HIPAA-aligned without being a covered '
                'entity?',
            a: 'We are the Business Associate (45 CFR §160.103). A signed '
          ...
          _Faq(
            ...
            a: 'You choose at provisioning: EU (Frankfurt, eur3) or US '
          ...
          _Faq(
            ...
            a: 'Yes. Settings → Data export gives you a JSON bundle with '
          ...
          _Faq(
            ...
            a: 'Three reasons: (1) clinicians can route their AI spend '
          ...
          _Faq(
            ...
            a: 'No. The AI surfaces DSM-5 differential candidates with the '
          ...
          _Faq(
            ...
            a: 'The AI features fall into the "limited risk" tier because '
