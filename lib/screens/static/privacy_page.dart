    ...
    return StaticPageShell(
      ...
      child: const Column(
        ...
        children: [
          ...
          StaticBullet(
              'No marketing, no resale, no ad networks. Ever.'),
