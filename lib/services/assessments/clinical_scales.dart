...
class ClinicalScales {
  ...
  static ScaleResult _scoreAudit(List<int> a) {
    ...
    if (total <= 7) {
      ...
      band = 'Hazardous use';
      guidance =
          'Hazardous drinking — deliver brief advice / motivational '
          'intervention and reassess.';
    } else if (total <= 19) {
      sev = ScaleSeverity.severe;
      band = 'Harmful use';
      guidance =
          'Harmful drinking — brief counselling and continued '
          'monitoring; consider referral.';
    } else {
      sev = ScaleSeverity.critical;
      band = 'Possible dependence';
      guidance =
          'Likely alcohol dependence — refer for diagnostic evaluation '
  ...
  static const ClinicalScale pcl5 = ClinicalScale(
    ...
    questions: [
      ...
      ScaleQuestion('Loss of interest in activities you used to enjoy', _freq5),
  ...
  static ScaleResult _scorePcl5(List<int> a) {
    ...
    if (total < 33) {
      ...
      guidance =
          'Below the provisional PTSD cut-off. Monitor symptoms and '
          'reassess if the clinical picture changes.';
    } else if (total < 50) {
      sev = ScaleSeverity.moderate;
      band = 'Probable PTSD';
      guidance =
          'Meets the provisional PTSD threshold. Confirm with a '
      ...
      guidance =
          'High symptom burden above threshold. Prioritize structured '
  ...
  static const ClinicalScale cssrs = ClinicalScale(
    ...
    questions: [
      ...
      ScaleQuestion('3. Have you thought about how you might do this?', _yesNo),
      ScaleQuestion(
