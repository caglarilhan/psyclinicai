// Screenshot every PsyClinicAI route after Sprint 14 polish.
//
// Usage:
//   1. `flutter build web --release`
//   2. `node scripts/screenshots/sprint14_screens.mjs`
...
// PNGs into `docs/screenshots/sprint-14/`.
...
const OUT_DIR = path.join(ROOT, 'docs', 'screenshots', 'sprint-14');
const PORT = 8765;
