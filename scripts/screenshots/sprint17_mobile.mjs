// Mobile-viewport variant of sprint17_screens.mjs.
//
// Captures every named route at iPhone 14 Pro size (390x844, 3x DPR)
// so we can ship desktop + mobile baselines side-by-side. Reuses the
// same in-process static server pattern. Output → docs/screenshots/
// sprint-17-mobile/.
...
const OUT_DIR = path.join(ROOT, 'docs', 'screenshots', 'sprint-17-mobile');
const PORT = 8766;
