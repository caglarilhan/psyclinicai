...
class PerformanceTestUtils {
  ...
  static void generatePerformanceReport(String testName, Duration duration) {
    print('⏱️  $testName: ${duration.inMilliseconds}ms');
  }
}
...
class DataValidationUtils {
  ...
  /// Validate data types
  static bool validateDataTypes(Map<String, dynamic> data, Map<String, Type> expectedTypes) {
    for (final entry in expectedTypes.entries) {
      if (data[entry.key] != null && data[entry.key].runtimeType != entry.value) {
        return false;
      }
    }
    return true;
