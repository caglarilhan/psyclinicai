...
Future<void> _pump(
  WidgetTester tester,
  Phq9Item9Recommendation rec,
) async {
  await tester.pumpWidget(
    MaterialApp(home: Scaffold(body: Phq9TriggerSheet(recommendation: rec))),
  );
...
void main() {
  group('Phq9TriggerSheet', () {
    ...
    testWidgets('score 2 — adds the safety plan secondary CTA',
        (tester) async {
    ...
    testWidgets('document-the-decision CTA is always shown',
        (tester) async {
      await _pump(tester, _router.evaluate({'phq9_9': 1}));
