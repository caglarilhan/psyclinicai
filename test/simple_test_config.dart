...
/// Simple test configuration for PsyClinicAI
class SimpleTestConfig {
  ...
  /// Initialize simple test environment
  static Future<void> initialize() async {
    ...
    print('✅ Simple test environment initialized');
  }
...
class SimpleTestUtils {
  ...
  static Map<String, dynamic> createTestUser() {
    return {
      'id': SimpleTestConfig.testUserId,
      'name': 'Test User',
  ...
  static Map<String, dynamic> createTestPatient() {
    return {
      'id': SimpleTestConfig.testPatientId,
      'name': 'Test Patient',
      'age': 30,
      'diagnosis': 'Depression',
    };
  ...
  static Map<String, dynamic> createTestAITask() {
    return {
      ...
      'status': 'pending',
      'patientId': SimpleTestConfig.testPatientId,
    };
  }
  ...
  static Map<String, dynamic> createTestBillingRecord() {
    return {
      'id': 'test_billing_001',
      'tenantId': SimpleTestConfig.testTenantId,
      'amount': 99.99,
      'status': 'pending',
    };
  }
  ...
  static Map<String, dynamic> createTestCollaborationSession() {
    return {
      ...
      'type': 'consultation',
      'status': 'active',
      'participants': [SimpleTestConfig.testUserId],
    };
  }
